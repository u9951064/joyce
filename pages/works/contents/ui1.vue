  ...
  <article>
      ...
      <div class="d-flex flex-align-flex-start">
        ...
        <div class="col-6 col-sm-10">
          <p class="fz-16-l gray2">
            希望藉由競賽參與提升 UI/UX 設計經驗並學習協作開發實務，我與 1
    ...
    <section class="container-1000 pt-80 pb-80 border-top-gray3">
      <div class="d-flex flex-align-flex-start">
        ...
        <div class="col-6 col-sm-10">
          <p class="fz-16-l gray2">
            我們主要以第三道主題「全台公車動態時刻查詢應用服務」進行設計開發。由於題目龐大賽程緊湊，在主辦方提供
            <a
              class="blue1"
    ...
    <!-- 03 執行階段 1. 資料蒐集 -->
    <section class="container-1000 pb-40">
      <div class="fz-22-m gray1 ml-8">03 執行階段</div>
      <ElementTag :class="'mt-30'">1. 資料蒐集</ElementTag>
    ...
    <section class="container-1000 pb-80">
      ...
      <ul class="fz-16-l gray2 pt-80">
        <ElementStarItem>
          ...
          背景以台灣特色建築淡淡的線條做裝飾，下方有一台小公車 Gif
          動畫作為點綴，使頁面更加活潑。
        </ElementStarItem>
      </ul>
